...
Frontend em `frontend/`: React 18, TypeScript, Vite, Tailwind, TanStack Query, react-hook-form + zod, zustand, react-router-dom v6, Radix primitives, lucide-react.
Antes de criar ou alterar qualquer tela, aplique a skill `pcp-design-system`.
