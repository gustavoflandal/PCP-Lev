...
Frontend em `frontend/`: TypeScript strict + Vite. Sem monorepo e sem tRPC — a API e REST em Go, consumida via axios + TanStack Query.
Tipos de contrato devem espelhar `docs/3_ESPECIFICACAO_APIS.md`.
