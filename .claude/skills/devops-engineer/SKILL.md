...
Deploy via Docker + Docker Compose (`docker-compose.yml`); CI em `.github/`. Frontend servido por nginx (`frontend/Dockerfile`, `frontend/nginx.conf`).
Postgres exposto na porta 5442 do host.
