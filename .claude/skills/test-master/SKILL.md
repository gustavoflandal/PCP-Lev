...
Backend: testify; unitarios junto ao pacote e integracao em `backend/tests/integration` (helpers em `internal/testsupport`). Rode com `go test ./...`.
Frontend: Vitest + Testing Library. Rode com `npm test` (cobertura: `npm run test:cobertura`).
