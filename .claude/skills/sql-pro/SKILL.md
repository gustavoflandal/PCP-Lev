...
Banco: PostgreSQL 16. Consultas ficam em `backend/internal/infra/repository`, escritas a mao com pgx/v5.
Esquema de referencia: `docs/2_ARQUITETURA_BANCO_DADOS.md`.
