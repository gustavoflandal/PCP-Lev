---
name: pcp-design-system
description: Sistema de design do PCP Enterprise. Use ao criar ou alterar QUALQUER interface do projeto — 
telas internas, portal do cliente, telas de coletor, componentes de @wms/ui, painéis, dashboards, formulários e tabelas. 
Define tokens de cor, tipografia, densidade, padrões de componente, estados semânticos (trilha verde/vermelho, severidades, estados de doca e saldo)
e as regras de acessibilidade. Responda sempre em português do Brasil.
---

# Sistema de Design — PCP Enterprise 

## 0. Antes de qualquer coisa

Este é um **sistema Planejamento e Controle da Produção**, não um site institucional. A tela
...
- Biblioteca de componentes fora de `@pcp/ui` (construída sobre Radix + Tailwind);
...
Definir como variáveis CSS em `@pcp/ui` e mapear no `tailwind.config`. Nunca
...
5. Se criou algo novo em `@pcp/ui`, documente o componente e seus estados.
