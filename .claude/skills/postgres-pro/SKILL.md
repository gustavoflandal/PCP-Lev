...
Banco: PostgreSQL 16 em container, porta **5442** no host. Migrations aplicadas pela API na subida.
Modelagem de referencia: `docs/2_ARQUITETURA_BANCO_DADOS.md`. Acesso via pgx/v5 puro, sem ORM.
