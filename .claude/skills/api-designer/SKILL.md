...
API REST versionada sob `/api/v1`, servida por Echo em `http://localhost:8000`.
O contrato vigente esta em `docs/3_ESPECIFICACAO_APIS.md` — mantenha o padrao de rotas, erros e paginacao ja definido la, em portugues.
